...
def scale_point_cloud_1(batch_data, smin=0.66, smax=1.5):
...
def translate_point_cloud_1(batch_data, tval=0.2):
...
def jitter_point_cloud_1(batch_data, sigma=0.01, clip=0.05):
    """ Randomly jitter points. jittering is per point.
        Input:
          BxNx3 array, original batch of point clouds
        Return:
